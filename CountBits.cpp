...
* numbers i in the range 0 ≤ i ≤ num calculate the 
...
* Or does the odd/even status of the number help you in 
...
// useful to read this: https://leetcode.com/discuss/92675/handle-this-question-interview-thinking-process-solution
